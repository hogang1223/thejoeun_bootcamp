...
class TableViewController: UITableViewController {
    ...
    // 앞으로 보여줄 화면 (Resume 같은건가?) viewDidLoad 1 , viewWillAppear 2번째로 실행됨 안쓰면 실행 안됨!
    override func viewWillAppear(_ animated: Bool) {
        tvListView.reloadData() // 테이블 관련 데이터 리로드 / 화면재구성
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "sgDetail" {
            ...
            detailView.detailContent = items[indexPath!.row]
            detailView.detailImage = itemsImageFile[indexPath!.row]
