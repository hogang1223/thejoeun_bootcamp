...
public class NetworkTaskImageAddHJ extends AsyncTask<Integer, String, Integer> {
    ...
    public NetworkTaskImageAddHJ(Context context, String mAddr, String devicePath, ImageView imageView) {
